...
class UserValidatorTest {
  ...
  void passwordsShouldMatch() {
    ...
    userForm.setPassword("secret12");
    userForm.setMatchingPassword("secret12");
  ...
  @Test
  void shouldGiveErrorWhenUsernameContainsOnlyWhitespace() {
    UserForm userForm = new UserForm();
    userForm.setAgree("true");
  ...
  @Test
  void shouldGiveErrorWhenPasswordMatchesUsername() {
    UserForm userForm = new UserForm();
    userForm.setAgree("true");
    userForm.setUsername("test1234");
